...
type UsageView struct {
	CurrentCacheEpoch                int64
	CurrentEpochMainInput            int
	CurrentEpochMainReportedInput    int
	...
	LifetimeMainOutput               int
	LifetimeMainRequests             int
	CompactionReportedInput          int
	CompactionRequests               int
	CompactionReportedRequests       int
	CompactionCacheReported          bool
	InputTokens                      int
