...
var slashCommands = []SlashCommand{
	...
	{Name: "forget", Usage: "/forget <memory-id>"},
	{Name: "recap", Usage: "/recap"},
	{Name: "reconcile", Usage: "/reconcile <attempt-id> <result>"},
	{Name: "cancel", Usage: "/cancel"},
	{Name: "status", Usage: "/status"},
	{Name: "context", Usage: "/context"},
	{Name: "language", Usage: "/language <en|zh-CN>"},
