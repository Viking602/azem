...
type Usage struct {
	CurrentCacheEpoch                int64  `json:"currentCacheEpoch,omitempty"`
	CurrentEpochMainInput            int    `json:"currentEpochMainInput,omitempty"`
	CurrentEpochMainReportedInput    int    `json:"currentEpochMainReportedInput,omitempty"`
	CurrentEpochMainCached           int    `json:"currentEpochMainCached,omitempty"`
	CurrentEpochMainCacheWrite       int    `json:"currentEpochMainCacheWrite,omitempty"`
	CurrentEpochMainRequests         int    `json:"currentEpochMainRequests,omitempty"`
	CurrentEpochMainReportedRequests int    `json:"currentEpochMainReportedRequests,omitempty"`
	CurrentEpochMainReported         bool   `json:"currentEpochMainReported,omitempty"`
	CurrentTurnMainInput             int    `json:"currentTurnMainInput,omitempty"`
	CurrentTurnMainReportedInput     int    `json:"currentTurnMainReportedInput,omitempty"`
	CurrentTurnMainCached            int    `json:"currentTurnMainCached,omitempty"`
	CurrentTurnMainOutput            int    `json:"currentTurnMainOutput,omitempty"`
	CurrentTurnMainRequests          int    `json:"currentTurnMainRequests,omitempty"`
	CurrentTurnMainReported          bool   `json:"currentTurnMainReported,omitempty"`
	LifetimeMainInput                int    `json:"lifetimeMainInput,omitempty"`
	LifetimeMainReportedInput        int    `json:"lifetimeMainReportedInput,omitempty"`
	LifetimeMainCached               int    `json:"lifetimeMainCached,omitempty"`
	LifetimeMainOutput               int    `json:"lifetimeMainOutput,omitempty"`
	LifetimeMainRequests             int    `json:"lifetimeMainRequests,omitempty"`
	LifetimeMainReported             bool   `json:"lifetimeMainReported,omitempty"`
	CompactionReportedInput          int    `json:"compactionReportedInput,omitempty"`
	CompactionRequests               int    `json:"compactionRequests,omitempty"`
	CompactionReportedRequests       int    `json:"compactionReportedRequests,omitempty"`
	CompactionCacheReported          bool   `json:"compactionCacheReported,omitempty"`
	TeamReportedInput                int    `json:"teamReportedInput,omitempty"`
	TeamRequests                     int    `json:"teamRequests,omitempty"`
	TeamReportedRequests             int    `json:"teamReportedRequests,omitempty"`
	TeamCacheReported                bool   `json:"teamCacheReported,omitempty"`
	SubagentInput                    int    `json:"subagentInput,omitempty"`
	SubagentReportedInput            int    `json:"subagentReportedInput,omitempty"`
	SubagentCached                   int    `json:"subagentCached,omitempty"`
	SubagentCacheWrite               int    `json:"subagentCacheWrite,omitempty"`
	SubagentOutput                   int    `json:"subagentOutput,omitempty"`
	SubagentReasoning                int    `json:"subagentReasoning,omitempty"`
	SubagentRequests                 int    `json:"subagentRequests,omitempty"`
	SubagentReportedRequests         int    `json:"subagentReportedRequests,omitempty"`
	SubagentCacheReported            bool   `json:"subagentCacheReported,omitempty"`
