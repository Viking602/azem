	...
	return []multiagent.AgentClass{
		{
			...
			Tools:        []string{coding.ToolListFiles, ToolGlob, coding.ToolReadFile, coding.ToolSearch, coding.ToolGitDiff, "todo"},
		...
		},
		{
			...
			Tools:        []string{coding.ToolListFiles, ToolGlob, coding.ToolReadFile, coding.ToolSearch, coding.ToolGitDiff, coding.ToolEditHashline, ToolReplace, coding.ToolWriteFile, ToolDeleteFile, coding.ToolGofmt, coding.ToolGoTest, ToolShell, "todo"},
		...
		},
		{
			...
			Tools:        []string{coding.ToolListFiles, ToolGlob, coding.ToolReadFile, coding.ToolSearch, coding.ToolGitDiff, coding.ToolGoTest, ToolShell},
