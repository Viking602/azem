const messages = {
  "zh-CN": {
    ...
    recapTitle: "会话回顾", recapEmpty: "成功完成一个回合后会在这里生成简短回顾。", recapGoal: "当前目标", recapOpenItems: "未完成事项", recapBoundary: "覆盖边界",
    ...
    running: "运行中", inProgress: "进行中", ready: "就绪", failed: "失败", completed: "完成", cancelled: "已取消", idle: "空闲", queued: "排队中",
    ...
    settingsNavExtensions: "插件、Skills 与运行时能力",
    ...
    extensionSkillsTitle: "Skills", extensionPluginsTitle: "插件", extensionPluginsHint: "插件可直接安装到 Azem 的 plugin-packages/local，也可从 Codex 导入；导入时会复制到 Azem 目录，不会直接读取 Codex 目录。", addMCPServer: "添加 MCP 服务", refreshMCP: "刷新 MCP 状态",
    mcpConnectedServicesMetric: "已连接 MCP", extensionSkillsMetric: "可用 Skills", extensionPluginsMetric: "已启用插件",
    extensionTabMCP: "MCP 服务", extensionTabSkills: "Skills", extensionTabPlugins: "插件", noMCPServers: "还没有 MCP 服务", noMCPServersHint: "添加本地 stdio 或远程 Streamable HTTP 服务。",
  ...
  en: {
    ...
    recapTitle: "Session recap", recapEmpty: "A concise recap appears here after a turn completes successfully.", recapGoal: "Current goal", recapOpenItems: "Open items", recapBoundary: "Covered boundary",
    ...
    running: "Running", inProgress: "In progress", ready: "Ready", failed: "Failed", completed: "Completed", cancelled: "Cancelled", idle: "Idle", queued: "Queued",
    // Codex-style approval modes
    ...
    settingsNavExtensions: "Plugins, Skills, and runtime capabilities",
    ...
    extensionSkillsTitle: "Skills", extensionPluginsTitle: "Plugins", extensionPluginsHint: "Install plugins directly in Azem's plugin-packages/local directory, or import them from Codex. Imports are copied into Azem and never loaded directly from Codex directories.", addMCPServer: "Add MCP service", refreshMCP: "Refresh MCP status",
    mcpConnectedServicesMetric: "Connected MCP", extensionSkillsMetric: "Available Skills", extensionPluginsMetric: "Enabled plugins",
    extensionTabMCP: "MCP services", extensionTabSkills: "Skills", extensionTabPlugins: "Plugins", noMCPServers: "No MCP services yet", noMCPServersHint: "Add a local stdio or remote Streamable HTTP service.",
