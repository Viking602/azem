const messages = {
  "zh-CN": {
    ...
    contextKernel: "压缩内核", semanticRevision: "语义版本", writerLag: "Writer 滞后", rebuildReason: "重建原因", contextSegments: "上下文分段",
	...
	routeMain: "默认会话模型", routeMainHint: "新会话和主任务默认使用的提供商、模型与推理强度。",
	...
	modelSettings: "模型设置", modelSettingsHint: "通过 llmux 配置模型提供商、API 地址、凭据和可用模型。API Key 只保存到受保护的凭据存储。",
	...
	signedIn: "已登录", notSignedIn: "未登录", subscriptionProvider: "订阅登录", subscriptionLoginRequired: "尚未登录订阅账户", subscriptionLoginHint: "登录后自动获取该订阅账户可用的模型。", subscriptionModelsHint: "模型由订阅服务实时返回，无需手动填写 API 地址或 API Key。", subscriptionModelsEmpty: "订阅服务暂未返回可用模型。", subscriptionTier: "订阅等级", subscriptionQuota: "订阅额度", subscriptionQuotaHint: "来自订阅服务的实时额度。", quotaRemaining: "剩余 {percent}%", quotaResetsAt: "{time} 重置", weeklyQuota: "每周额度", quotaBalance: "额外额度", quotaUnlimited: "无限额度", quotaUnavailable: "获取失败", login: "登录", logout: "退出登录", working: "处理中…",
	...
	modelID: "模型 ID", displayName: "显示名称", contextWindow: "上下文窗口", maxOutputTokens: "最大输出", reasoningLevels: "思考等级", defaultReasoning: "默认思考", noDefaultReasoning: "未设置", noReasoningLevels: "无思考等级", modelCapabilities: "模型能力", removeModel: "移除模型",
    ...
    settingsAppearance: "界面", settingsAppearanceHint: "调整应用语言、主题与全局界面字体。",
    settingsExtensions: "Skills 与扩展", settingsExtensionsHint: "查看运行时发现的本地能力目录。",
    settingsNavModels: "标题、计划、压缩与各子智能体模型", settingsNavSubagents: "并发与任务调度",
  ...
  en: {
	...
	modelSettings: "Model settings", modelSettingsHint: "Configure llmux providers, API endpoints, credentials, and available models. API keys are stored only in the protected credential store.",
	...
	modelID: "Model ID", displayName: "Display name", contextWindow: "Context window", maxOutputTokens: "Max output", reasoningLevels: "Reasoning levels", defaultReasoning: "Default reasoning", noDefaultReasoning: "Not set", noReasoningLevels: "No reasoning levels", modelCapabilities: "Model capabilities", removeModel: "Remove model",
    ...
    settingsNavModels: "Title, plan, compaction, and subagent models", settingsNavSubagents: "Concurrency and scheduling",
