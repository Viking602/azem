const messages = {
  "zh-CN": {
    ...
    speed: "速度", standardSpeed: "标准", fastSpeed: "快速", fastModeHint: "快速模式仅对支持订阅加速的 ChatGPT/Codex 模型生效。",
  ...
  en: {
    ...
    speed: "Speed", standardSpeed: "Standard", fastSpeed: "Fast", fastModeHint: "Fast mode only applies to supported ChatGPT/Codex models.",
