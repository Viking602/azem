const messages = {
  "zh-CN": {
	...
	signedIn: "已登录", notSignedIn: "未登录", subscriptionProvider: "订阅登录", subscriptionLoginRequired: "尚未登录订阅账户", subscriptionLoginHint: "登录后自动获取该订阅账户可用的模型。", subscriptionModelsHint: "模型由订阅服务实时返回，无需手动填写 API 地址或 API Key。", subscriptionModelsEmpty: "订阅服务暂未返回可用模型。", refreshSubscriptionModels: "获取模型", subscriptionTier: "订阅等级", subscriptionQuota: "订阅额度", subscriptionQuotaHint: "来自订阅服务的实时额度。", quotaRemaining: "剩余 {percent}%", quotaResetsAt: "{time} 重置", weeklyQuota: "每周额度", quotaBalance: "额外额度", quotaUnlimited: "无限额度", quotaUnavailable: "获取失败", login: "登录", logout: "退出登录", working: "处理中…",
    ...
    settingsSubagents: "子智能体", settingsSubagentsHint: "控制团队运行的并发容量和资源隔离；前台工具与子智能体分别限流。",
  ...
  en: {
    ...
    settingsSubagents: "Subagents", settingsSubagentsHint: "Cap concurrent subagent tasks; extras queue automatically.",
    settingsGovernance: "Governance & approvals", settingsGovernanceHint: "Default approval policy and how new messages are handled while a turn is running.",
