const messages = {
  "zh-CN": {
	...
	resetInherit: "恢复继承", routeNotConfigured: "未配置",
	    routeTitle: "会话标题", routePlan: "规划模型", routeApproval: "审批模型", routeVision: "视觉模型", routeCompaction: "上下文压缩",
    ...
    settingsExtensions: "扩展", settingsExtensionsHint: "管理 MCP 服务、Skills 与 Codex 插件；Hooks 默认不受信任。",
    ...
    extensionSkillsTitle: "Skills", extensionPluginsTitle: "Codex 插件", addMCPServer: "添加 MCP 服务", refreshMCP: "刷新 MCP 状态",
    mcpServicesMetric: "MCP 服务", mcpConnectedMetric: "已连接", extensionSkillsMetric: "可用 Skills", extensionPluginsMetric: "已启用插件",
    ...
    noPluginsInstalled: "没有发现已安装插件", noPluginsInstalledHint: "Skills 与 MCP 可以独立使用；安装 Codex 插件后会在这里显示。",
    ...
    enableMCP: "启用 {server}", disableMCP: "停用 {server}", reconnectMCP: "重新连接 {server}", mcpRuntimeHint: "启停会立即应用；正在运行的会话保留已取得的工具快照。",
  ...
  en: {
	...
	resetInherit: "Reset to inherit", routeNotConfigured: "Not configured",
	    routeTitle: "Session titles", routePlan: "Plan mode", routeApproval: "Approve for me", routeVision: "Image assistance", routeCompaction: "Context compaction",
    ...
    settingsExtensions: "Extensions", settingsExtensionsHint: "Manage MCP services, Skills, and Codex plugins; hooks remain untrusted by default.",
    ...
    extensionSkillsTitle: "Skills", extensionPluginsTitle: "Codex plugins", addMCPServer: "Add MCP service", refreshMCP: "Refresh MCP status",
    mcpServicesMetric: "MCP services", mcpConnectedMetric: "Connected", extensionSkillsMetric: "Available Skills", extensionPluginsMetric: "Enabled plugins",
    ...
    noPluginsInstalled: "No installed plugins discovered", noPluginsInstalledHint: "Skills and MCP work independently; installed Codex plugins will appear here.",
    ...
    enableMCP: "Enable {server}", disableMCP: "Disable {server}", reconnectMCP: "Reconnect {server}", mcpRuntimeHint: "Enable and disable apply immediately; active turns retain the tool snapshot they already acquired.",
