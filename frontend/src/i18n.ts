const messages = {
  "zh-CN": {
	...
	settingsNavCatalog: "提供商、凭据与模型目录", searchProviders: "搜索 llmux 提供商…", searchMoreProviders: "另有 {count} 个提供商，输入名称搜索",
	noProviders: "没有可用的 llmux 提供商。", enabled: "已启用", enableProvider: "启用提供商", apiBaseURL: "API 地址", apiKey: "API Key",
	keepCredential: "留空以保留现有凭据", credentialStored: "已保存在受保护的凭据存储中。", credentialEnvironment: "正在使用环境变量 {key}。", credentialNotRequired: "此本地提供商不要求 API Key。", credentialMissing: "填写 API Key，或设置环境变量 {key}。",
	models: "模型", providerModelsHint: "填写该提供商允许在 Azem 中选择的全部模型。", addModel: "添加模型", noConfiguredModels: "尚未配置模型。",
	modelID: "模型 ID", displayName: "显示名称", contextWindow: "上下文窗口", reasoningLevels: "推理等级", defaultReasoning: "默认推理", removeModel: "移除模型",
  ...
  en: {
	...
	settingsNavCatalog: "Providers, credentials, and model catalog", searchProviders: "Search llmux providers…", searchMoreProviders: "{count} more providers; search by name",
	noProviders: "No llmux providers available.", enabled: "Enabled", enableProvider: "Enable provider", apiBaseURL: "API base URL", apiKey: "API key",
	keepCredential: "Leave blank to keep the current credential", credentialStored: "Stored in the protected credential store.", credentialEnvironment: "Using environment variable {key}.", credentialNotRequired: "This local provider does not require an API key.", credentialMissing: "Enter an API key or set environment variable {key}.",
	models: "Models", providerModelsHint: "List every model this provider should expose in Azem.", addModel: "Add model", noConfiguredModels: "No models configured.",
	modelID: "Model ID", displayName: "Display name", contextWindow: "Context window", reasoningLevels: "Reasoning levels", defaultReasoning: "Default reasoning", removeModel: "Remove model",
