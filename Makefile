...
ifeq ($(shell uname -s),Darwin)
	...
	cp gpui/macos/AppIcon.icns dist/Azem-GPUI.app/Contents/Resources/AppIcon.icns
	...
	mkdir -p dist/Azem-GPUI.app/Contents/Resources/locales
	cp gpui/assets/locales/*.json dist/Azem-GPUI.app/Contents/Resources/locales/
	...
	mkdir -p dist/gpui/locales
	cp gpui/assets/locales/*.json dist/gpui/locales/
endif
